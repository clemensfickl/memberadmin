...
describe('Service Tests', () => {
    ...
    describe('TrainingGroupMember Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TrainingGroupMemberService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/training-group-members';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TrainingGroupMember', () => {
