...
describe('Service Tests', () => {
    ...
    describe('ContributionGroupEntry Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ContributionGroupEntryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/contribution-group-entries';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ContributionGroupEntry', () => {
